...
if __name__ == "__main__":
    ...
    print "svm(linear) the accruacy socre is ", score

    ## 参考sklearn，计算混淆矩阵和F1值
    ...
    # 原代码的准确率
    score = accuracy_score(test_labels, test_predict)
    print "svm(poly) the accruacy socre is ", score
