...
from search_solr_str_spell import *
...
def solr_app_match_str_spell(query_str, result_f):
    """
    ...
    flag = search_solr_str_spell(ref_str, ref_spell, cand_f, count=COUNT)
    if flag == "-1":
        sys.exit(0)
    cand_spell = []
    ...
    os.system(shell_cmd)
    shell_cmd = "head -n 20 " + result_f + " > " + tmp_f
    os.system(shell_cmd)
...
if __name__ == '__main__':
    ...
    """
    result = solr_app_match_str_spell(sys.argv[1], sys.argv[2])
