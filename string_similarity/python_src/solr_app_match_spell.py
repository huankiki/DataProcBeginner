...
def solr_app_match_spell(query_str, result_f):
    """
    ...
    flag = search_solr_spell(ref_spell, cand_f, count=COUNT)
    if flag == "-1":
        sys.exit(0)
    cand_spell = []
...
if __name__ == '__main__':
    ...
    """
    result = solr_app_match_spell(sys.argv[1], sys.argv[2])
