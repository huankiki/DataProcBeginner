...
url_body = 'http://10.10.10.102:8984/solr/resource/select?q=(title:'
url_dict = {
  "title": "青花",
  "start": 0,
  "rows": 10
...
def search_solr(query_str, out_file, count=10):
    """
    ...
    url = url_body + str_escape_solr(url_dict["title"]) + ')&start=0&rows=' + str(url_dict["rows"])
    #print url
...
if __name__ == '__main__':
    ...
    # search
    result = search_solr(in_str, out_file, count)
    print result
